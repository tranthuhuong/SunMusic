...
import com.example.huongthutran.sunmusic.ui.FragmentHomeOverview;
import com.example.huongthutran.sunmusic.ui.FragmentHomeOverview;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (savedInstanceState == null) {
            getSupportFragmentManager().beginTransaction().replace(R.id.myContainer, new FragmentHomeOverview(), String.valueOf(new FragmentHomeOverview().getId())).commit();
        }
    };
